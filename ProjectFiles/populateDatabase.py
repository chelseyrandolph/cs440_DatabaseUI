...
for x in range(0, 50):
    ...
    # addNewPatient(firstName, middleInitial, lastName, phoneNumber, address, email, insurN, insurID)

    r = addNewDoctor(firstName, middleInitial, lastName, phoneNumber, email, title)
    print(r + " " + str(x))
