...
for x in range(0, 50):
    ...
    r = addNewPatient(firstName, middleInitial, lastName, phoneNumber, address, email, insurN, insurID)
    print(r + " " + str(x))
# addNewDoctor(firstName, middleInitial, lastName, phoneNumber, email, title)
